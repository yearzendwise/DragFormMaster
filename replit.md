...
- **Enhanced Boolean Switch Dark Theme Compatibility**: Completely redesigned yes/no switch component with high-contrast colors for dark themes, including slate-700 background for unchecked state, white thumb with enhanced shadows, and bright white labels for maximum visibility on dark backgrounds
