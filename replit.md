...
- **Enhanced Boolean Switch Dark Theme Compatibility**: Improved yes/no switch component with better contrast, enhanced label styling, and optimized colors for both light and dark themes, including specific CSS overrides for dark mode appearance
