...
const defaultThemes: FormTheme[] = [
  // Enhanced existing themes
  {
    ...
    styles: {
      ...
      booleanSwitch: {
        track: 'data-[state=unchecked]:bg-gray-200 data-[state=checked]:bg-blue-500 border-gray-300',
  ...
  },
  {
    ...
    styles: {
      ...
      booleanSwitch: {
        track: 'data-[state=unchecked]:bg-gray-300 data-[state=checked]:bg-gradient-to-r data-[state=checked]:from-purple-500 data-[state=checked]:to-pink-500 border-gray-300',
  ...
  },
  {
    ...
    styles: {
      ...
      booleanSwitch: {
        track: 'data-[state=unchecked]:bg-slate-300 data-[state=checked]:bg-blue-600 border-slate-400',
        thumb: 'bg-white shadow-lg',
  ...
  },
  {
    ...
    styles: {
      ...
      booleanSwitch: {
        track: 'data-[state=unchecked]:bg-pink-200 data-[state=checked]:bg-gradient-to-r data-[state=checked]:from-pink-500 data-[state=checked]:to-purple-600 border-pink-300',
        thumb: 'bg-white shadow-lg',
  ...
  },
  {
    ...
    styles: {
      ...
      booleanSwitch: {
        track: 'data-[state=unchecked]:bg-gray-700 data-[state=checked]:bg-gradient-to-r data-[state=checked]:from-yellow-400 data-[state=checked]:to-yellow-500 border-gray-600',
  ...
  // New themes
  {
    ...
    styles: {
      ...
      background: 'bg-gray-900',
      booleanSwitch: {
        track: 'data-[state=unchecked]:bg-gray-800 data-[state=checked]:bg-gradient-to-r data-[state=checked]:from-cyan-400 data-[state=checked]:to-green-400 border-cyan-400',
  ...
  },
  {
    ...
    styles: {
      ...
      booleanSwitch: {
        track: 'data-[state=unchecked]:bg-green-200 data-[state=checked]:bg-gradient-to-r data-[state=checked]:from-green-600 data-[state=checked]:to-emerald-600 border-green-300',
        thumb: 'bg-white shadow-lg',
  ...
  },
  {
    ...
    styles: {
      ...
      booleanSwitch: {
        track: 'data-[state=unchecked]:bg-purple-800 data-[state=checked]:bg-gradient-to-r data-[state=checked]:from-yellow-400 data-[state=checked]:to-yellow-500 border-purple-600',
        thumb: 'bg-white shadow-xl',
  ...
  },
  {
    ...
    styles: {
      ...
      booleanSwitch: {
        track: 'data-[state=unchecked]:bg-yellow-300 data-[state=checked]:bg-gradient-to-r data-[state=checked]:from-orange-500 data-[state=checked]:to-pink-500 border-orange-400 border-4',
        thumb: 'bg-white shadow-lg',
