          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center space-x-3 mb-2">
              <input
                ...
                className="text-xl font-bold text-slate-800 bg-transparent border-none outline-none focus:ring-0 placeholder-slate-400"
                placeholder="Untitled Form"
              />
              <div className="flex items-center space-x-1">
                <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
                <span className="text-xs text-slate-500 font-medium">Auto-saved</span>
              </div>
            </div>
            <p className="text-sm text-slate-600 flex items-center">
              {previewMode ? (
                ...
                <>
                  ...
                  Build mode - drag components from the sidebar or click to add
                </>
              )}
            </p>
          </div>
